 ...
 * @LastEditTime: 2022-06-12 20:06:38
...
// 代理对象
const p51 = new Proxy(obj, {
  // 拦截读取操作，接收第三个参数receiver
  get(target, key, receiver) {
    console.log(p51 === receiver, target === obj);
...
// 使用Reflect.foo读取
// console.log(Reflect.get(obj2, "foo", { foo: "xiaomi" })); // 有误，为啥不是xiaomi，还是1
